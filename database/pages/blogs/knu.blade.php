                ...
                <div class="featured-courses-list w-clearfix w-dyn-items w-row">
                    ...
                    <div class="featured-course-item w-col w-col-6 w-dyn-item">
                        <div class="course-block-wrapper">
                            <a class="course-image-link-block large w-inline-block" href="{{route('pages.blog.knu.show', $b->slug)}}" style="background-image: url('/files/storage/app/{{$b->image}}');">
                            </a>
                            <div class="course-content-block">
                                <a class="course-title-link with-summary" href="{{route('pages.blog.knu.show', $b->slug)}}">
                                    {{$b->name}}
                                </a>
