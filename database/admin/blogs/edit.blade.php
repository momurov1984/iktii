    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('blog.index')}}">Новости КНУ</a></li>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('url', 'Ссылка (url адрес на сайт knu.kg)') !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="row justify-content-start">
                                @foreach($blog->knuUpload as $bu)
                                    <div class="col-sm-2">
                                        <img src='{{asset("files/storage/app/{$bu->uploads}")}}' class="img-thumbnail img-fluid" alt="Responsive image">
                                        {!! Form::open(['route' => ['knuUpload.delete', $bu->id], 'method' => 'delete']) !!}
                                        <button class="del-bak" type="submit" href="{{route('knuUpload.delete', $bu->id)}}">
                                            Удалить
                                        </button>
                                        {!! Form::close() !!}
                                    </div>
