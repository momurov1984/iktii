    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('fiitBlog.index')}}">Новости ФИИТ</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'fiitBlog.store', 'method' => 'put', 'files' => true]) !!}
                        <div class="form-group">
                            {!! Form::label('name', 'Название блога ФИИТ') !!}
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Название блога ФИИТ']) !!}
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea('body', null, ['class' => 'form-control', 'placeholder' => 'Описание блога']) !!}
                            @if($errors->has('body'))
                                <span class="text-danger">Это поле обьязательно!</span>
                            @endif
                        </div>
