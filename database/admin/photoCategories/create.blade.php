    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('photoCategory.index')}}">Фотогалерея (категории)</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {!! Form::open(['route' => 'photoCategory.store', 'method' => 'put', 'files' => true]) !!}
                        <div class="form-group">
                            {!! Form::label('name', 'Название Фотогалерея (категории)') !!}
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Название Фотогалерея (категории)']) !!}
                            @if($errors->has('name'))
