                            ...
                            <div class="featured-course-item w-col w-col-6 w-dyn-item">
                                <div class="course-block-wrapper">
                                    <div class="course-content-block flex-department-single">
                                        <div class="w-col-12">
                                        <a class="course-title-link with-summary" href="<?php echo e(route('pages.department.chartMaterial', [$chart->slug, $cc->id])); ?>">
                                            <?php echo e($cc->name); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\open_server_5_3_7_basic_full\OpenServer\domains\fiit\files\resources\views/pages/departments/chart.blade.php ENDPATH**/ ?>