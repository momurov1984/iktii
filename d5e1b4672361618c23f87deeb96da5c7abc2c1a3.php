...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Добавление состав кафедры</h1>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Добавление состав кафедры</li>
            </ol>
        </div>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Добавление состав кафедры</h6>
                    </div>
                    <div class="card-body">
                        <?php echo Form::open(['route' => 'teamDepartment.store', 'method' => 'put', 'files' => true]); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OS\OSPanel\domains\fiit.loc\files\resources\views/admin/teamDepartments/create.blade.php ENDPATH**/ ?>