        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php echo Form::open(['route' => 'chartContent.store', 'method' => 'put', 'files' => true]); ?>

                        <div class="form-group">
                            <?php echo Form::label('name', 'Какой курс'); ?>

                            <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => '1 курс, 2 курс']); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OS\OSPanel\domains\fiit.loc\files\resources\views/admin/chartContents/create.blade.php ENDPATH**/ ?>