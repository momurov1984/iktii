<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse
            ...
            <?php echo e(request()->route()->getName() === 'teamDepartment.index' ? 'show' : ''); ?>

            <?php echo e(request()->route()->getName() === 'files.index' ? 'show' : ''); ?>

            <?php echo e(request()->route()->getName() === 'terms.index' ? 'show' : ''); ?>

            <?php echo e(request()->route()->getName() === 'disciplines.index' ? 'show' : ''); ?>
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item <?php echo e(request()->route()->getName() === 'teamDepartment.index' ? 'active' : ''); ?>" href="<?php echo e(route('teamDepartment.index')); ?>">
                    Сотрудники
                </a>
                <a class="collapse-item <?php echo e(request()->route()->getName() === 'files.index' ? 'active' : ''); ?>" href="<?php echo e(route('files.index')); ?>">
                    Файлы
                </a>
                <a class="collapse-item <?php echo e(request()->route()->getName() === 'terms.index' ? 'active' : ''); ?>" href="<?php echo e(route('terms.index')); ?>">
                    Семестры
                </a>
                <a class="collapse-item <?php echo e(request()->route()->getName() === 'disciplines.index' ? 'active' : ''); ?>" href="<?php echo e(route('disciplines.index')); ?>">
                    Дисциплины
                </a>
            </div>
        </div>
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo e(request()->route()->getName() === 'instruction.index' ? 'active-bg' : ''); ?>" href="<?php echo e(route('instruction.index')); ?>">
    ...
    <li class="nav-item">
        <a class="nav-link <?php echo e(request()->route()->getName() === 'programs.index' ? 'active-bg' : ''); ?>" href="<?php echo e(route('programs.index')); ?>">
            <i class="fab fa-fw fa-wpforms"></i>
...
<?php /**PATH D:\OS-Panel\domains\Ikt\files\resources\views/admin/include/sidebar.blade.php ENDPATH**/ ?>