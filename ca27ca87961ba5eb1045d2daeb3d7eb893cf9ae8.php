                            ...
                            <div class="course-block-wrapper">
                                <div class="course-content-block flex-department-single">
                                    <div class="w-col-12">
                                        ...
                                        <br>
                                        <?php $__currentLoopData = $department->program; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="w-col w-col-4 program-block">
                                            <a class="course-title-link" href='<?php echo e(url("files/storage/app/{$p->pdf}")); ?>' target="_blank">
                                                <?php echo e($p->name); ?>

                                            </a>
                                            <a href='<?php echo e(url("files/storage/app/{$p->pdf}")); ?>' target="_blank" class="pdf-d-s">Скачать</a>
                                        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/m/mommyc6w/fiit.bstudios.ru/public_html/files/resources/views/pages/departments/program.blade.php ENDPATH**/ ?>