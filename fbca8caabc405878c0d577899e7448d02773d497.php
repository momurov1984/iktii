        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <?php echo Form::open(['route' => 'department.store', 'method' => 'put', 'files' => true]); ?>

                        <div class="form-group">
                            <?php echo Form::label('name', 'Название Кафедры'); ?>

                            <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Название Кафедры']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php echo Form::textarea('body', null, ['class' => 'form-control', 'placeholder' => 'Описание Кафедры']); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\OS\OSPanel\domains\fiit.loc\files\resources\views/admin/departments/create.blade.php ENDPATH**/ ?>