                    ...
                    <div class="dropdown w-dropdown" data-delay="0" data-hover="1">
                        ...
                        <nav class="dropdown-list w-dropdown-list">
                            <?php $__currentLoopData = \App\Category::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a class="dropdown-link w-dropdown-link" href="<?php echo e(route('pages.category', $category->slug)); ?>"><?php echo e($category->name); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\OS-Panel\domains\Ikt\files\resources\views/layout.blade.php ENDPATH**/ ?>